    ...
    const submitHandler =(e:SyntheticEvent)=>{
        ...
        signInWithEmailAndPassword(auth, email, password)
            ...
            .catch( (error)=>{ 
                ...
                if(error=="FirebaseError: Firebase: Error (auth/invalid-credential)."||error=="FirebaseError: Firebase: Error (auth/invalid-email)."){
  ...
  return (
    ...
    <div className={`${styles.login_div}`}>
          <form className={`${styles.form}`} onSubmit={submitHandler}>
              ...
              <p className={`${styles.heading}`}>Login to</p>
            ...
            <div className={`${styles.wrapper}`}>
              ...
              <div className={`${styles.btn}`}>
                  ...
                  <Link to='/signup'><button className={`${styles.button2}`}> No account? Sign Up</button>
                  </Link>
              </div>
